...
// Collection of a few refactored card functions to fulfil 
// the requirements of CS362 Assignment 2.
////////////////////////////////////////////////////////////
...
int actionAdventurer(struct gameState *state, int handPos) {
	...
	while(z - 1 >= 0){ // discard all cards in play that have been drawn
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
		case adventurer:
			actionAdventurer(state, handPos);
			return 0;

		case council_room:
			actionCouncilRoom(state, handPos);		
			return 0;

		case feast:
			actionFeast(state, handPos, choice1);     			
			return 0;
		...
		case smithy:
			actionSmithy(state, handPos);
			return 0;

		case village:
			actionVillage(state, handPos);
			return 0;
